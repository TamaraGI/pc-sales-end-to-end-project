...
CONSTRAINT fk_store_id
           ...
           references [computer_std].[dbo].[dim_store] ([store_id]),
CONSTRAINT fk_product_id
           foreign key ([product_id])
           references [computer_std].[dbo].[dim_product] ([product_id]),
...
CONSTRAINT fk_payment_method_id
           ...
           references [computer_std].[dbo].[dim_payment_method] ([payment_method_id]),
